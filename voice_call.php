...
$application_id = "6fc3c8c0-6fbc-488a-a2fa-f7e52d4670cd";
...
echo ("Hi, using your key: " . $nexmo_key . " and secret: " . $nexmo_secret . "to make a Call with Voice API.<br><br>");
...
{
	echo ("Can't see an application, let's create one for you.<br><br>");
	$action = '/applications/?';
	...
	if ( ! is_readable($application_id) ){
		print ("Please add the private key for your application in a file named " . $application_id + " in  the same directory as this script.<br><br>" );

	}

}

echo ("Using application ID " . $application_id . " to call " .  $phone_number_to_call . "<br><br>");

/*
 Make a TTS Call to a phone number
 */
echo ("Generate a JWT for  " . $application_id . ".<br><br>");
$jwt = generate_jwt($application_id, $application_id);

echo ("This JWT authenticates you when you make a request to one of our endpoints: <br><br>  " . $jwt . ".<br><br>");
...
echo ("Use the following payload to make the Call: <br><br>" .  $payload . "<br><br>");

echo ("answer_url is pointing to the webhook endpoint providing the NCCO that manages the Call.<br><br>" );

echo ("And make the Call. <br><br>" );
//Create the request
$ch = curl_init();
...
$response = curl_exec($ch);
echo ("The Call status is: " . $response . "<br><br>" );
